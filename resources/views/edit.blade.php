...
<div style="background: linear-gradient(90deg,rgba(131,58,180,1) 0%, rgba(253,29,29,1)46%,rgba(252,176,69,1)100%)!important;" class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Malumot tahrirlash formasi</h2>
    </div>
    <form action="{{route('update',['id'=>$product->id])}}" method="POST" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
                ...
                <div class="mt-2.5">
                    <input type="text" value="{{$product->title}}" name="title" id="first-name" autocomplete="given-name"
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input type="number" value="{{$product->price}}" name="price" id="last-name" autocomplete="family-name"
                           class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div class="sm:col-span-2">
                ...
                <div class="mt-2.5">
                    <input type="text" value="{{$product->shortcontent}}" name="shortcontent" id="malumot"
                           class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div class="sm:col-span-2">
                ...
                <div class="mt-2.5">
                    <textarea name="body"  id="message" rows="4"
                              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{$product->body}}</textarea>
                </div>
            </div>
            <div class="sm:col-span-2">
                <label for="message" class="block text-sm font-semibold leading-6 text-gray-900">Rasmi</label>
                <div class="mt-2.5">
                    <input type="file" value="{{storage_path('files').$product->image}}" name="image" id="image">
                </div>
            </div>
        </div>
        <div class="mt-10">
